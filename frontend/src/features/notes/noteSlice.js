...
// loading can be inferred from presence or absence of notes
// success can be inferred from presence or absence of notes
// error messages can be received at component level from our AsyncThunkAction
